		...
		<div class="container">
			<div class="row">
                ...
                <div class="page-title text-center col-md-6">
					<h1>Om meg</h1>
					<p>Hei, som domene sier er jeg altså Jørgen. <br>Jeg ble født i Porsgrunn og oppvokst i Bamble i Telemark.
                        Nå for tiden bor jeg i Kristiansand og studerer ved Universitetet i Agder (UIA).
                        Her går jeg på et 2-årlig Master-studie: Informasjonssystemer. På fritiden driver jeg gjerne med webprogrammering og liker også å leke meg litt med mobil applikasjonsutvikling,
                        hovedsakelig da Android utvikling. Etterhvert kommer jeg også til å legge ut en oversikt/portefølje som kan vise litt hva jeg har jobbet med!
						...
						<div class="team-info">
							...
							<div class="fig-caption">
								...
								<ul class="team-social">
									<li class="bgblue-dark"><a href="https://www.facebook.com/JorgenJohansen93"><i class="fa fa-facebook"></i></a></li>
								    <li class="bgblue-light"><a href="https://github.com/jorjoh"><i class="fa fa-github"></i></a></li>
								    <li class="bgblue-dark"><a href="https://www.linkedin.com/in/j%C3%B8rgen-johansen-06046970/"><i class="fa fa-linkedin"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
